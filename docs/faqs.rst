...
--------------------------------------------------------------
We don offer HMMer searches against our metagenomic protein database via the web site `sequence search facility <https://www.ebi.ac.uk/metagenomics/sequence-search/search/phmmer>`_.
